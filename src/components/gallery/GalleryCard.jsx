...
export default function GalleryCard({ album, onOpen }) {
  return (
    <article
      className="group relative w-full h-full rounded-2xl overflow-hidden cursor-pointer bg-[#0f172a] shadow-sm hover:-translate-y-1.5 hover:shadow-2xl transition-all duration-300 ease-out focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#ff6b35]"
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-4 transition-transform duration-300 group-hover:-translate-y-1">
        ...
        <div className="flex items-end justify-between gap-3">
          ...
          <div
            aria-hidden="true"
            className="shrink-0 w-9 h-9 rounded-full flex items-center justify-center text-white bg-white/15 border border-white/25 backdrop-blur-sm transition-all duration-300 group-hover:bg-[#ff6b35] group-hover:border-[#ff6b35] group-hover:translate-x-0.5 group-hover:shadow-[0_4px_12px_rgba(255,107,53,0.45)]"
          >
